        ...
        <>
            <div className='px-2 pb-6'>
                    ...
                    <div className='w-full pl-0 sm:w-3/4 lg:w-2/4 lg:pl-[30px]'>
                        <div>
                            ...
                            <div className='flex justify-start'>
                                ...
                                <span className='cursor-pointer text-indigo-600 text-base font-medium hover:text-indigo-500 transition'>{product.rating.count} перегляди</span>
                            </div>
                ...
                <div className='mt-[100px]'>
                    <p className='text-xl font-medium w-fit border-b-2 border-b-gray-500 mx-auto lg:mx-0'>Вас також може зацікавити</p>
